                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr key={skill.id}  className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td className="px-6 py-4"><Link to={`/skills/${skill.id}/edit`} className="px-4 py-2 bg-yellow-500 hover:bg-indigo-700 text-white rounded-md">Edit</Link></td>
                            <td className="px-6 py-4"><button onClick={() => deleteSkill(skill.id)} className="px-4 py-2 bg-red-500 hover:bg-indigo-700 text-white rounded-md">Delete</button></td>
                        </tr>
